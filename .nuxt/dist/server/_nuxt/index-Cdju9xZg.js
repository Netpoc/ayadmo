import { _ as __nuxt_component_0 } from "./nuxt-link-CCHD2ZLS.js";
import { defineComponent, mergeProps, useSSRContext, ref, computed, unref, watch, withCtx, createTextVNode } from "vue";
...
import { a as useIntersectionObserver } from "./index-CCiy6Pq_.js";
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Transform your export data into strategic economic insights. Real-time global indicators, correlation analysis, and 5-year forecasts."
        }
      ]
    });
    const features = [
...
//# sourceMappingURL=index-Cdju9xZg.js.map
