import { defineComponent, ref, mergeProps, isRef, unref, useModel, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderTeleport, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useEventListener } from './index-CCiy6Pq_.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></section><section class="max-w-xl mx-auto"><h2 class="text-2xl font-bold text-primary-dark dark:text-accent-teal text-center mb-6"> Contact </h2><p class="text-center text-gray-600 dark:text-gray-400 mb-6"> Email: contact@ayadmo-analytics.com \xB7 Phone: +1 (555) 000-0000 </p><button type="button" class="mx-auto block rounded-lg bg-primary-dark dark:bg-accent-teal px-6 py-3 font-semibold text-white transition hover:opacity-90"> Send a message </button></section></div>`);
...
//# sourceMappingURL=about-BrV16ur9.mjs.map
