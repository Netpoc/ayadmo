...
const _routes = [
  ...
  },
  {
    name: "docs",
    path: "/docs",
    component: () => import('./docs-D3cQHNgp.mjs')
  },
  {
    name: "about",
    path: "/about",
  ...
  },
  {
    name: "features",
    path: "/features",
    component: () => import('./features-B6NxdOLW.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BPZmmcEd.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bxdo-6bK.mjs'));
